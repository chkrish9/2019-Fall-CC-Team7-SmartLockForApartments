(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var ngx_bootstrap_timepicker__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ngx-bootstrap/timepicker */ "./node_modules/ngx-bootstrap/timepicker/fesm2015/ngx-bootstrap-timepicker.js");
            ...
            /* harmony import */ var _services_common_auth_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./services/common/auth.service */ "./src/app/services/common/auth.service.ts");
            ...
            /* harmony import */ var _components_common_header_header_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./components/common/header/header.component */ "./src/app/components/common/header/header.component.ts");
            ...
            /* harmony import */ var _components_apartment_apartment_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./components/apartment/apartment.component */ "./src/app/components/apartment/apartment.component.ts");
            /* harmony import */ var _components_access_access_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./components/access/access.component */ "./src/app/components/access/access.component.ts");
            var appRoutes = [
                { path: "", component: _components_login_login_component__WEBPACK_IMPORTED_MODULE_14__["LoginComponent"], canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_17__["AuthGuard"]] },
                { path: "home", component: _components_home_home_component__WEBPACK_IMPORTED_MODULE_15__["HomeComponent"], canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_17__["AuthGuard"]] },
                { path: "apartment", component: _components_apartment_apartment_component__WEBPACK_IMPORTED_MODULE_20__["ApartmentComponent"], canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_17__["AuthGuard"]] },
                { path: "access", component: _components_access_access_component__WEBPACK_IMPORTED_MODULE_21__["AccessComponent"], canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_17__["AuthGuard"]] }
            ];
            function getToken() {
            ...
            AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
                    declarations: [
                        ...
                        _components_common_header_header_component__WEBPACK_IMPORTED_MODULE_18__["HeaderComponent"],
                        _components_common_sidemenu_sidemenu_component__WEBPACK_IMPORTED_MODULE_19__["SidemenuComponent"],
                        _components_apartment_apartment_component__WEBPACK_IMPORTED_MODULE_20__["ApartmentComponent"],
                        _components_access_access_component__WEBPACK_IMPORTED_MODULE_21__["AccessComponent"]
                    ],
                    imports: [
                        ...
                        ngx_bootstrap_timepicker__WEBPACK_IMPORTED_MODULE_12__["TimepickerModule"].forRoot(),
                        _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forRoot(appRoutes)
                    ],
                    providers: [_services_common_auth_service__WEBPACK_IMPORTED_MODULE_16__["AuthService"], _guards_auth_guard__WEBPACK_IMPORTED_MODULE_17__["AuthGuard"], _auth0_angular_jwt__WEBPACK_IMPORTED_MODULE_9__["JwtHelperService"]],
        ...
        /*!*******************************************************!*\
          !*** ./src/app/components/access/access.component.ts ***!
          \*******************************************************/
        /*! exports provided: getTimepickerConfig, AccessComponent */
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            "use strict";
            __webpack_require__.r(__webpack_exports__);
            /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getTimepickerConfig", function () { return getTimepickerConfig; });
            ...
            function getTimepickerConfig() {
                return Object.assign(new ngx_bootstrap_timepicker__WEBPACK_IMPORTED_MODULE_3__["TimepickerConfig"](), {
                    showMeridian: false,
                    readonlyInput: false,
                    mousewheel: true,
                    showMinutes: true,
            ...
            var AccessComponent = /** @class */ (function () {
                function AccessComponent(toasterService, accessService) {
                ...
                AccessComponent.prototype.getAccessCode = function () {
                    var _this = this;
                    this.accessService.getAllByRommno(this.access.roomnumber).subscribe(function (data) {
                        _this.accesses = data;
                    });
                };
                AccessComponent.prototype.choose = function (value) {
                    var type = value;
                    var roomnumber = localStorage.getItem("roomnumber");
                    this.access.code = "";
                    this.getAccessByTypeAndRoom(type, roomnumber);
                };
                AccessComponent.prototype.getAccessByTypeAndRoom = function (type, roomnumber) {
                    var _this = this;
                    this.accessService.getByTypeAndRoomno(type, roomnumber).subscribe(function (data) {
                        if (data["length"] > 0) {
                            if (type === "code" || type === "otcode") {
                                ...
                                _this.access.type = "scode";
                                _this.accesses = data;
                            }
                        }
                        else {
                            _this.isNew = true;
                            _this.access.type = type;
                        }
                    });
                };
                AccessComponent.prototype.showInput = function () {
                    this.showcode = true;
                };
                AccessComponent.prototype.generateCode = function () {
                    var _this = this;
                    this.accessService.generateCode().subscribe(function (data) {
                        _this.access.code = data.toString();
                    });
                };
                AccessComponent.prototype.dateChanged = function ($event) {
                ...
                AccessComponent.prototype.save = function () {
                    ...
                    this.accessService.addAccess(this.access).subscribe(function (data) {
                        //this.access = data;
                        if (_this.access.type === 'scode') {
                            _this.getAccessByTypeAndRoom(_this.access.type, _this.access.roomnumber);
                        }
                        var toast = {
                            type: "success",
                            title: "Success",
                ...
                AccessComponent.prototype.update = function () {
                    var _this = this;
                    this.access.active = true;
                    this.access.roomnumber = localStorage.getItem("roomnumber");
                    this.access.dateOfEntry = this.access.dateOfEntry !== "" ? this.formateDate(this.access.dateOfEntry) : "";
                    this.access.startTime = this.access.startTime !== "" ? this.getTime(this.access.startTime) : "";
                    this.access.endTime = this.access.endTime !== "" ? this.getTime(this.access.endTime) : "";
                    this.accessService.updateAccess(this.access).subscribe(function (data) {
                        if (_this.access.type === 'scode') {
                            _this.getAccessByTypeAndRoom(_this.access.type, _this.access.roomnumber);
                        }
                        var toast = {
                ...
                AccessComponent.prototype.getCode = function () {
                    var codes = this.accesses;
                    var code = {
                        roomnumber: "",
                        type: "",
                        code: "",
                ...
                AccessComponent.prototype.setDate = function (time) {
                    var d = new Date();
                    d.setHours(time.split(':')[0]);
                    d.setMinutes(time.split(':')[1]);
                    return d;
                };
                AccessComponent.prototype.getTime = function (dateObj) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HomeComponent = /** @class */ (function () {
                function HomeComponent(modalService, router, authService, roomService, homeService, toasterService) {
                ...
                HomeComponent.prototype.getAllByRommno = function (roomno) {
                    var _this = this;
                    this.homeService.getAllByRommno(roomno).subscribe(function (data) {
                        _this.images = data;
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AccessService = /** @class */ (function () {
                function AccessService(http, authService) {
                    this.http = http;
                    this.authService = authService;
                }
                AccessService.prototype.addAccess = function (access) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        "Content-Type": "application/json",
                        Authorization: this.authService.getToken()
                    });
                    var url = this.authService.prepEndpoint("access/create");
                    return this.http.post(url, access, { headers: headers });
                };
                AccessService.prototype.updateAccess = function (access) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        "Content-Type": "application/json",
                        Authorization: this.authService.getToken()
                    });
                    var url = this.authService.prepEndpoint("access/update/");
                    url = url + access._id;
                    return this.http.put(url, access, { headers: headers });
                };
                AccessService.prototype.deleteAccess = function (id) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        "Content-Type": "application/json",
                        Authorization: this.authService.getToken()
                    });
                    var url = this.authService.prepEndpoint("access/delete/");
                    return this.http.delete(url + id, { headers: headers });
                };
                AccessService.prototype.getAccess = function () {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        "Content-Type": "application/json",
                        Authorization: this.authService.getToken()
                    });
                    var url = this.authService.prepEndpoint("access/all/");
                    return this.http.get(url, { headers: headers });
                };
                AccessService.prototype.generateCode = function () {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        "Content-Type": "application/json",
                        Authorization: this.authService.getToken()
                    });
                    var url = this.authService.prepEndpoint("access/generatecode/");
                    return this.http.get(url, { headers: headers });
                };
                AccessService.prototype.getAllByRommno = function (roomno) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        "Content-Type": "application/json",
                        Authorization: this.authService.getToken()
                    });
                    var url = this.authService.prepEndpoint("access/allbyrommno/");
                    return this.http.get(url + roomno, { headers: headers });
                };
                AccessService.prototype.getAccessByCode = function (code) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        "Content-Type": "application/json",
                        Authorization: this.authService.getToken()
                    });
                    var url = this.authService.prepEndpoint("access/get/");
                    return this.http.get(url + code, { headers: headers });
                };
                AccessService.prototype.getByTypeAndRoomno = function (type, roomno) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                        "Content-Type": "application/json",
                        Authorization: this.authService.getToken()
                    });
                    var url = this.authService.prepEndpoint("access/gettyperoomno/");
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HomeService = /** @class */ (function () {
                ...
                HomeService.prototype.getAllByRommno = function (roomno) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]({
                        "Content-Type": "application/json",
                        Authorization: this.authService.getToken()
                    });
                    var url = this.authService.prepEndpoint("home/all/");
                    return this.http.get(url + roomno, { headers: headers });
                };
                return HomeService;
            }());
